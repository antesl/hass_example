...
Датчик открытия входной двери точно показывается, когда кто-то вошел\вышел.
Пинг показывает, что определенный пользователь появился в домашней зоне умного дома.
...
3) Если датчик открытия входной двери, срабатывает, когда таймер запущен, то передается команда на Яндекс станцию поприветствовать пользователя и таймер останавливается. 
...
Разобраться, что делать, когда два и более пользователя входят одновременно.
Тут или что-то выдумывать с группами. 
Или подойдет другой режим автоматизации - queued. 
